                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" v-model="idcategoria">
                                        ...
                                        <option v-text="categoria.nombre" v-for="categoria in arrayCategoria" :key="categoria.id" :value="categoria.id"> Seleccione </option>
                                    </select>
                                </div>
                            </div>
                             <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" v-model="stock" class="form-control" placeholder="999">
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    'barcode': VueBarcode
        ...
        methods : {
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                //Enviar la peticion para visualizar la data de la página
            ...
            desactivarArticulo(id){
                ...
                title: '¿Está seguro que desea desactivar este articulo?',
                text: "Su archivo no se mostrara en el buscador",
                type: 'warning',
            ...
            activarArticulo(id){
                ...
                text: "Su archivo  se mostrara en el buscador",
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Aceptar',
                cancelButtonText: 'Cancelar',
            ...
            validarArticulo(){
                ...
                if(!this.nombre) this.errorMostrarMsjArticulo.push("El nombre de la Articulo no puede estar vacio");
